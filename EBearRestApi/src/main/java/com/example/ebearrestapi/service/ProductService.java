...
public class ProductService {
    ...
    public ProductDetailResult detailProduct(Long productId) {
        ...
        return ProductDetailResult.builder()
                ...
                .thumbnail(thumbnailFile.getFileLocation() + thumbnailFile.getSaveFileName())
                .content(board.getContent())
                .seller(product.getUser().getUserName())
                .sellerImg(product.getUser().getFile().getFileLocation() + product.getUser().getFile().getSaveFileName())
